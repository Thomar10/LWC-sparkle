...
public final class Schwaemm256256TestBigM {
  ...
  void initializeTest() {
    ...
    SchwaemmHelper data = SchwaemmHelper.prepareTest(SchwaemmType.S256256, 33, 64);
  ...
  void encryptAndDecrypt() {
    SchwaemmHelper data = SchwaemmHelper.prepareTest(SchwaemmType.S256256, 64, 128);
  ...
  void verifyTagFailsOnRandomInput() {
    ...
    Assertions.assertThatThrownBy(() -> schwaemmJava.verifyTag(data.stateJ(),
            ConversionUtil.createIntArrayFromBytes(randomCipher,
                SchwaemmType.S256256.getVerifyTagLength())))
