...
public record SchwaemmHelper(byte[] key, byte[] nonce, byte[] associate, byte[] message,
  ...
  public static SchwaemmHelper prepareTest(SchwaemmType type, int minLength, int maxLength, Random random) {
